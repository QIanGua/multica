    ...
    entries: [
      {
        version: "0.4.32",
        date: "2026-08-21",
        title: "插件版本、项目视图与工作区席位",
        changes: [],
        features: [
          "插件作者可发布多个版本，管理员可指定安装其中任一版本。",
          "钉钉机器人现在会在所属智能体下显示已活跃的群组。",
          "看板和列表现在可按项目分组查看。",
          "订阅已启用时，工作区管理员可在账单页增加席位。",
        ],
        improvements: [
          "活跃的智能体任务现在能更高效地同步更新。",
          "自托管服务器在 PostgreSQL 短暂不可用后能更可靠地恢复。",
          "Telegram 的设置提示和回复现在使用英文。",
        ],
        fixes: [
          "手动重新运行不再中断仍在执行的智能体任务。",
          "并发任务不再覆盖彼此的本地工作目录。",
          "OpenClaw、Pi 和 OpenCode 现在可稳定使用已配置的自定义提供商。",
          "切换工作区不再中断实时更新或提及功能。",
          "自动化 Webhook 凭据不再出现在普通命令行输出中。",
        ],
      },
      {
        version: "0.4.31",
