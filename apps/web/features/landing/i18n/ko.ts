      ...
      entries: [
        {
          version: "0.4.34",
          date: "2026-08-25",
          title: "문맥을 담은 하위 Issue, 사용자 지정 상태, 안정적인 에이전트 작업",
          changes: [],
          features: [
            "댓글에서 하위 Issue를 만들고 원래 맥락을 보존할 수 있습니다.",
            "워크스페이스 관리자가 사용자 지정 Issue 상태를 만들 수 있습니다.",
          ],
          improvements: [
            "처음 입력한 뒤 결제에 이메일이 자동으로 채워집니다.",
            "저장소 가져오기에 실패하면 액세스 복구 방법을 알려줍니다.",
            "셀프 호스팅 환경에서 하나의 주소로 상태를 확인할 수 있습니다.",
          ],
          fixes: [
            "MCode 세션이 안정적으로 시작됩니다.",
            "제거된 멤버에게 Autopilot 알림이 더 이상 전송되지 않습니다.",
            "복구된 에이전트 작업이 원래 댓글 스레드에 유지됩니다.",
            "Issue 댓글에 올바른 현지 시간이 표시됩니다.",
            "전체 Issue ID를 안정적으로 열 수 있습니다.",
            "에이전트 작업이 끝나면 올바르게 종료됩니다.",
            "비활성 구독 좌석이 청구에 표시되지 않습니다.",
            "거부된 태스크 토큰이 태스크 중지 방법을 알려줍니다.",
          ],
        },
        {
          version: "0.4.33",
