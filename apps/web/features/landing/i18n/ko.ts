      ...
      entries: [
        {
          version: "0.4.32",
          date: "2026-08-21",
          title: "플러그인 버전, 프로젝트 보기, 워크스페이스 좌석",
          changes: [],
          features: [
            "플러그인 작성자는 여러 버전을 게시하고 관리자는 설치할 버전을 선택할 수 있습니다.",
            "DingTalk 봇이 활동한 그룹을 해당 에이전트 아래에서 볼 수 있습니다.",
            "보드와 테이블을 프로젝트별로 그룹화해 볼 수 있습니다.",
            "구독이 켜진 경우 관리자는 청구 화면에서 좌석을 추가할 수 있습니다.",
          ],
          improvements: [
            "활성 에이전트 실행의 업데이트가 더 효율적으로 동기화됩니다.",
            "셀프 호스팅 서버가 PostgreSQL의 일시적 중단 후 더 안정적으로 복구됩니다.",
            "Telegram 안내와 답변이 이제 영어로 표시됩니다.",
          ],
          fixes: [
            "수동으로 다시 실행해도 진행 중인 에이전트 작업은 중단되지 않습니다.",
            "동시에 실행되는 작업이 서로의 로컬 작업 공간을 덮어쓰지 않습니다.",
