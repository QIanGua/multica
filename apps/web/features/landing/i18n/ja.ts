      ...
      entries: [
        {
          version: "0.4.34",
          date: "2026-08-25",
          title: "文脈付き子 Issue、カスタムステータス、安定したエージェント実行",
          changes: [],
          features: [
            "コメントから子 Issue を作成し、元の文脈を保持できます。",
            "ワークスペース管理者はカスタム Issue ステータスを作成できます。",
          ],
          improvements: [
            "初回入力後、チェックアウトにメールアドレスが入ります。",
            "リポジトリ取得の失敗時に、アクセスを復旧する方法が分かります。",
            "セルフホスト版は一つのアドレスで正常性を確認できます。",
          ],
          fixes: [
            "MCode セッションが安定して開始します。",
            "削除されたメンバーに Autopilot 通知が届かなくなります。",
            "復旧したエージェント実行が元のコメントスレッドに残ります。",
            "Issue コメントに正しいローカル時刻が表示されます。",
            "完全な Issue ID を安定して開けます。",
            "エージェント実行が完了時に正しく終了します。",
            "無効なサブスクリプションの席数が請求に表示されません。",
            "拒否されたタスクトークンでタスクの停止方法が分かります。",
          ],
        },
        {
          version: "0.4.33",
