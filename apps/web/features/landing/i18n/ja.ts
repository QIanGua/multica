      ...
      entries: [
        {
          version: "0.4.32",
          date: "2026-08-21",
          title: "プラグインのバージョン、プロジェクト表示、ワークスペースの席数",
          changes: [],
          features: [
            "プラグインの作成者は複数のバージョンを公開し、管理者は導入する版を選べます。",
            "DingTalk ボットの利用グループが、担当エージェントの下に表示されます。",
            "ボードとテーブルをプロジェクトごとにグループ化して表示できます。",
            "サブスクリプション有効時、管理者は請求画面から席数を追加できます。",
          ],
          improvements: [
            "アクティブなエージェントの実行が、より効率的に更新されます。",
            "セルフホスト版は PostgreSQL の一時停止後も、より確実に復旧します。",
            "Telegram の案内と返信が英語で表示されます。",
          ],
          fixes: [
            "手動で再実行しても、実行中のエージェント タスクは中断されません。",
            "同時実行中のタスクが、互いのローカル作業ディレクトリを上書きしません。",
