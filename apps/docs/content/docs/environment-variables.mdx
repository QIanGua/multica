...
| `RATE_LIMIT_INVITATION_RECIPIENT_24H` | `3` | Invitations one normalized recipient email may receive across workspaces per 24-hour sliding window; `0` disables this gate |
