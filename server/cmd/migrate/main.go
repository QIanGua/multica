...
var concurrentIndexCleanups = map[string]string{
	...
	"353_plugin_invocation_installation_index":                  "idx_plugin_invocation_installation_created",
	"354_plugin_invocation_created_at_index":                    "idx_plugin_invocation_created_at",
}
